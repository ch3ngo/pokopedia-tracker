  ...
  return (
    <>
      <div
        ...
        className={`rounded-2xl border transition-all duration-200 cursor-pointer hover:shadow-md
          ${isComplete
      ...
      >
        <div className="p-4 flex gap-4 items-start">
          {/* Habitat image — 200x200, left side */}
          ...
          <div className="flex-1 min-w-0 flex flex-col gap-2">
            <div>
              ...
              <div className="flex items-start gap-2">
                <h3 className="font-bold text-sm text-gray-900 dark:text-white leading-tight flex-1">{name}</h3>
            ...
            <button
              ...
              className={`flex items-center justify-center gap-1 py-1.5 rounded-xl text-xs font-semibold transition-colors mt-auto
